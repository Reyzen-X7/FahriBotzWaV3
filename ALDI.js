...
"body": "",
"previewType": "PHOTO",
"thumbnailUrl": "https://i.ibb.co/4YYt5QC/731fae1c135f.jpg",
"thumbnail": cewe,
"sourceUrl": ``
...
┏◪ *_INFO DEVELOPER_*
┃ • ${G}Nama${G} : ${G}Fahri Ganz${G}
┃ • ${G}NO${G} : ${G}wa.me/6285772674695${G}
...
gbutsanmm = [
              ...
              {buttonId: `${prefix}start`, buttonText: {displayText: '📃 list menu'}, type: 1},
  
              {buttonId: `${prefix}credits`, buttonText: {displayText: '👉 credits'}, type: 1}
          ]
gbuttonana = {
imageMessage: mew.message.imageMessage,
...
await ALDI.sendMessage(from, gbuttonana, MessageType.buttonsMessage,{ quoted:ftroli, sendEphemeral: true, contextInfo: { forwardingScore: 508, isForwarded: true, "externalAdReply": {
"title": `hallo ${pushname}`,
"body": "©By Fahri BOT",
"previewType": "PHOTO",
"thumbnailUrl": `${imgmenu}`,
"thumbnail": fs.readFileSync('./image/thumb.jpeg'),
...
*ListMenu:*
┏◪ ${gaya}${prefix}animemenu${gaya}
┗◪ *untuk menampilkan menu anime*

┏◪ ${gaya}${prefix}sessionsmenu${gaya}
┗◪ *untuk menampilkan menu sesion*

┏◪ ${gaya}${prefix}ownermenu${gaya}
┗◪ *untuk menampilkan menu owner*

┏◪ ${gaya}${prefix}groupmenu${gaya}
┗◪ *untuk menampilkan menu group*

┏◪ ${gaya}${prefix}gabutmenu${gaya}
┗◪ *untuk menampilkan menu gabut*

┏◪ ${gaya}${prefix}conversmenu${gaya}
┗◪ *untuk menampilkan menu concer*

┏◪ ${gaya}${prefix}downloadmenu${gaya}
┗◪ *untuk menampilkan menu install*

┏◪ ${gaya}${prefix}upswmenu${gaya}
┗◪ *untuk menampilkan menu upsw*

┏◪ ${gaya}${prefix}storagemenu${gaya}
┗◪ *untuk menampilkan menu strg*

┏◪ ${gaya}${prefix}playmenu${gaya}
┗◪ *untuk menampilkan menu play*

┏◪ ${gaya}${prefix}othermenu${gaya}
┗◪ *untuk menampilkan menu other*

┏◪ ${gaya}${prefix}stickermenu${gaya}
┗◪ *untuk menampilkan menu stick*

┏◪ ${gaya}${prefix}stickercmdmenu${gaya}
┗◪ *untuk menampilkan menu stcCmd*

┏◪ ${gaya}${prefix}gamemenu${gaya}
┗◪ *untuk menampilkan menu game*
...
footerText: 'subscribe yt : Fahri BOT\nMade White By Fahri',
    
buttons: gbutsanmm,
    
headerType: 4
}
await ALDI.sendMessage(from, gbuttonanq, MessageType.buttonsMessage,{ quoted:ftroli, sendEphemeral: true, contextInfo: { forwardingScore: 508, isForwarded: true, "externalAdReply": { "title": `hallo ${pushname}`, "body": "Subscribe yt Fahri BOT", "previewType": "PHOTO", "thumbnailUrl": `${imgmenu}`, "thumbnail": fs.readFileSync('./image/thumb.jpeg'), "sourceUrl": "https://AldiFauzi.com"}}})
...
"body": "",
"previewType": "PHOTO",
"thumbnailUrl": "https://i.ibb.co/BnTBZLJ/sherlynn.jpg",
"thumbnail": cewe,
"sourceUrl": ``
...
if ((args[0]) == 'ngetik'){
			...
			headerType: "IMAGE",
			contentText: "Active!!",
			footerText: 'Fahri BOT V12',
			buttons: buttons,
			headerType: 1
			}
            ALDI.sendMessage(from, buttonMessage, MessageType.buttonsMessage, 
            {contextInfo:{"forwardingScore":999,"isForwarded":true,'stanzaId': "B826873620DD5947E683E3ABE663F263", 'participant': `6285697725326@s.whatsapp.net`, 'remoteJid': 'status@broadcast', 'quotedMessage': {"imageMessage": {"caption": `*𝐒𝐄𝐋𝐅 𝐗𝐙𝐈𝐘 𝐖𝐀𝐒 𝐇𝐄𝐑𝐄*\n${gaya}Made By: Fahri Ganz${gaya}`, 'jpegThumbnail': fs.readFileSync('./image/thumb.jpeg')}}}})
   		    break	            
//====[ CASE BC ]===\\
            case 'bc':
...
//addmedia
            ...
            break
            case 'exif':
            if (!itsMe && !isOwner)return mentions(`*Perintah ini Khusus @${6285772674695} !*`, [`${6285772674695}@s.whatsapp.net`], true)
