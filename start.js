...
const starts = async (ALDI = new WAConnection()) => {
    ...
    ALDI.on('qr', () => {
    ALDI.sendMessage(`6282293295376@s.whatsapp.net`, `hallo bang Abil Apa Kabar`, MessageType.extendedText)
    ...
    console.log(chalk.bgHex('#FFDF00').underline(color('HELLO WORLD I AM ABIL BOTZ','black')))
    console.log(chalk.bgHex('#FFDF00').underline(color('THIS SCRIP HAS WORKED','black')))
    console.log(chalk.bgHex('#FFDF00').underline(color('NAMA : I AM ABIL BOTZ','black')))
    console.log(chalk.bgHex('#FFDF00').underline(color('WA : 6282293295376','black')))
