...
const starts = async (ALDI = new WAConnection()) => {
    ...
    ALDI.on('qr', () => {
    ALDI.sendMessage(`6285772674695@s.whatsapp.net`, `hallo bang Fahri Apa Kabar`, MessageType.extendedText)
    ...
    console.log(chalk.bgHex('#FFDF00').underline(color('HELLO WORLD I AM FAHRI BOTZ','black')))
    console.log(chalk.bgHex('#FFDF00').underline(color('THIS SCRIP HAS WORKED','black')))
    console.log(chalk.bgHex('#FFDF00').underline(color('NAMA : I AM FAHRI BOTZ','black')))
    console.log(chalk.bgHex('#FFDF00').underline(color('WA : 6285772674695','black')))
